...
public class BluetoothCommService {
    ...
    private PeerDevice mCurrPeer;
    
    private static BluetoothCommService mService = null;
    
    public static BluetoothCommService createService(Context context, Handler handler) {
    	if (mService == null)
    		mService = new BluetoothCommService(context, handler);
    	return mService;
    }
     ...
     */
    private BluetoothCommService(Context context, Handler handler) {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(SetupActivity.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        Message msg = mHandler.obtainMessage(SetupActivity.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(SetupActivity.DEVICE_NAME, device.getName());
        msg.setData(bundle);
        mHandler.sendMessage(msg);
        
        mCurrPeer = new PeerDevice();
        mCurrPeer.setDeviceName(device.getName());
     ...
     * @see ConnectedThread#write(byte[])
     */
    public void write(byte[] out, int start, int len) {
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(SetupActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(SetupActivity.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(SetupActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(SetupActivity.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(SetupActivity.MESSAGE_READ, bytes, -1, buffer)
                            .sendToTarget();
                } catch (IOException e) {
